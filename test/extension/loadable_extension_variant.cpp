...
extern "C" {
DUCKDB_EXTENSION_API void loadable_extension_variant_init(duckdb::DatabaseInstance &db) {
	Connection con(db);
...
DUCKDB_EXTENSION_API const char *loadable_extension_variant_version() {
